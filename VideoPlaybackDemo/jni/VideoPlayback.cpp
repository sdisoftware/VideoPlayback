...
Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_getOpenGlEsVersionNative(JNIEnv *, jobject)
{
...
Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_setActivityPortraitMode(JNIEnv *, jobject, jboolean isPortrait)
{
...
JNIEXPORT int JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_initTracker(JNIEnv *, jobject)
{
    LOG("Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_initTracker");
...
JNIEXPORT void JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_deinitTracker(JNIEnv *, jobject)
{
...
JNIEXPORT int JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_loadTrackerData(JNIEnv *, jobject)
{
    ...
    // Load the data sets:
    if (!dataSetStonesAndChips->load("NumNum.xml", QCAR::DataSet::STORAGE_APPRESOURCE))
    {
...
JNIEXPORT int JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_destroyTrackerData(JNIEnv *, jobject)
{
...
JNIEXPORT void JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_onQCARInitializedNative(JNIEnv *, jobject)
{
     QCAR::setHint(QCAR::HINT_MAX_SIMULTANEOUS_IMAGE_TARGETS, 2);
}

JNIEXPORT jint JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlaybackRenderer_getVideoTextureID(JNIEnv* env, jobject obj, jint target )
{
...
JNIEXPORT void JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlaybackRenderer_setStatus(JNIEnv* env, jobject obj, jint target, jint value)
{
...
Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_isTapOnScreenInsideTarget(JNIEnv *env, jobject, jint target, jfloat x, jfloat y)
{
...
JNIEXPORT void JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlaybackRenderer_setVideoDimensions(JNIEnv *env, jobject, jint target, jfloat videoWidth, jfloat videoHeight, jfloatArray textureCoordMatrix)
{
...
JNIEXPORT bool JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlaybackRenderer_isTracking(JNIEnv *, jobject, jint target)
{
    return isTracking[target];
}

JNIEXPORT void JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlaybackRenderer_renderFrame(JNIEnv *, jobject)
{
    ...
    for(int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
    {
        ...
        if (strcmp(imageTarget.getName(), "NumNum") == 0)
...
JNIEXPORT void JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_initApplicationNative(
                            JNIEnv* env, jobject obj, jint width, jint height)
{
    ...
    jmethodID getTextureMethodID = env->GetMethodID(activityClass,
        "getTexture", "(I)Lcom/sdisoftware/videoplaybackdemo/Texture;");
...
JNIEXPORT void JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_deinitApplicationNative(
...
JNIEXPORT void JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_startCamera(JNIEnv *,
                                                                         jobject)
{
...
JNIEXPORT void JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_stopCamera(JNIEnv *, jobject)
{
...
JNIEXPORT void JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_setProjectionMatrix(JNIEnv *, jobject)
{
...
Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_autofocus(JNIEnv*, jobject)
{
    return QCAR::CameraDevice::getInstance().setFocusMode(QCAR::CameraDevice::FOCUS_MODE_TRIGGERAUTO) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlayback_setFocusMode(JNIEnv*, jobject, jint mode)
{
    int qcarFocusMode;
...
JNIEXPORT void JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlaybackRenderer_initRendering(
                                                    JNIEnv* env, jobject obj)
{
...
JNIEXPORT void JNICALL
Java_com_sdisoftware_videoplaybackdemo_VideoPlaybackRenderer_updateRendering(
                        JNIEnv* env, jobject obj, jint width, jint height)
{
